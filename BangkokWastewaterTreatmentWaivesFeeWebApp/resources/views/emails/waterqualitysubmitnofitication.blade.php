...
<body>
    ...
    <div class="body">
      ...
      <p>เจ้าหน้าที่ได้ทำการตรวจสอบผลตรวจวัดคุณภาพน้ำของการยื่นแบบหมายเลข: <b>{{ $details['document_no'] }}</b> แล้ว</p>
      <p>รายงานผลปี: <b>{{ $details['water_quality_year'] }}</b></p>
      <p>รายงานผลเดือน: <b>{{ $details['water_quality_month'] }}</b></p>
      <br>

      @if ($details['document_status'] == 2)
        <p>ผลการตรวจสอบเอกสาร: <span style='color: green'>{{ $details['quality_status_desc'] }}</span></p>
      @endif

      @if ($details['document_status'] == 3)
        <p>ผลการตรวจสอบเอกสาร: <span style='color: red'>{{ $details['quality_status_desc'] }}</span></p>
      @endif
