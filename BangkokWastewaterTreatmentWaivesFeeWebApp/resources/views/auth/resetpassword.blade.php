        ...
        <div class="mb-auto w-75 p-2">
          <div class="row justify-content-center align-items-center">
            <div class="col-12">
              ...
              <h5 class="text-center text-success mt-3">กำหนดรหัสผ่านใหม่</h5>
              <form class="mt-3" method="POST" action="/service/user/resetpassword">
                @csrf
                <input type="hidden" name="username" value="{{$username}}">
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label text-success">รหัสผ่านใหม่ <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label text-success">ยืนยันรหัสผ่านใหม่ <span class="text-danger">*</span></label>
