        ...
        <div class="mb-auto w-75 p-2">
          <div class="row justify-content-center align-items-center">
            <div class="col-12">
              ...
              <h5 class="text-center text-success mt-3">ลงทะเบียนผู้ใช้งานใหม่</h5>
              <form class="mt-3" method="POST" action="/service/user/register">
                @csrf
                <div class="mb-2">
                  <label for="exampleFormControlInput1" class="form-label text-success">อีเมล <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label text-success">รหัสผ่าน <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label text-success">ยืนยันรหัสผ่าน <span class="text-danger">*</span></label>
                ...
                <div class="d-grid gap-2 mb-5">
                  <button type="submit" class="btn btn-success" id="btn-login">สร้างบัญชีผู้ใช้งาน</button>
                </div>
