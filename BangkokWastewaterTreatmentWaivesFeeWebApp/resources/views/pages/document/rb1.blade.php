...
<main class="flex-shrink-0">
  <div class="container-fluid h-100">
    ...
    <div class="container">
      <!-- begin #navbar -->
      @include('components.navbar', ['active'=> 'pagedocumentrb1'])
      <!-- end #navbar -->
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb my-4">
          ...
          <li class="breadcrumb-item active" aria-current="page">
            แบบ รบ.1 คำขอรับบริการบำบัดน้ำเสียของกรุงเทพมหานคร
          </li>
        </ol>
      </nav>
        ...
        <div class="card mb-5 mt-3">
          <div class="card-body">
            ...
            @if (Request::get("doc_no") != "")
              @include('pages.form.rb1', ['action' => 'readwrite'])

              <!-- Button update -->
              <div class="d-grid gap-2 col-6 mx-auto">
                <button class="btn btn-warning btn-lg" type="button" id="btn_update_document_rb1">บันทึกและยื่นเอกสารเพิ่มเติม</button>
              </div>
            @else
              @include('pages.form.rb1', ['action' => 'freeform'])

              <!-- Button save -->
              <div class="d-grid gap-2 col-6 mx-auto">
                <button class="btn btn-blue-bg btn-lg" type="button" id="btn_create_document_rb1">ยืนยันยื่นแบบ</button>
              </div>
            @endif
          </div>
        </div>
