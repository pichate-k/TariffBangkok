...
<main class="d-flex flex-nowrap">
  ...
  @include('components.leftmenu', ['active'=> 'pageadminreportdocumentapproved'])
  ...
  <div class="container-fluid my-4" style="overflow-y: auto;">
    ...
    <div class="card mt-3">
      <div class="card-body">
        <h4 class="text-blue">
          <i class="fa-solid fa-list-check text-warning"></i> รายงานผู้ได้รับการอนุมัติแล้ว
        </h4>
        <a href="/service/doc/reportUserDocumentApproveExcel" type="button" class="btn btn-blue-bg" target="_blank">ดาวน์โหลดรายชื่อผู้ได้รับการยกเว้นค่าธรรมเนียมบำบัดน้ำเสีย</a>
...
<script src="{{ asset('js/report-document-approved.js') }}"></script>
