...
<main class="d-flex flex-nowrap">
  ...
  @include('components.leftmenu', ['active'=> 'pageadminreportdocumentconnectpipe'])
  ...
  <div class="container-fluid my-4" style="overflow-y: auto;">
    ...
    <div class="card mt-3">
      <div class="card-body">
        <h4 class="text-blue">
          <i class="fa-solid fa-list-check text-warning"></i> รายชื่อการขอรับบริการบำบัดน้ำเสีย
        </h4>
        <a href="/service/doc/reportUserDocumentApproveConnectPipeExcel" type="button" class="btn btn-blue-bg" target="_blank">ดาวน์โหลดรายงานการขอรับบริการบำบัดน้ำเสีย</a>
...
<script src="{{ asset('js/report-document-connectpipe.js') }}"></script>
