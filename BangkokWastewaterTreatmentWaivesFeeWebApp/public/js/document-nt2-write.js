...
$(document).on("click", "#btn_create_document_nt2", function(event, data) {
    let formDocumentNT2 = new FormData($("#fm_document_nt2")[0]);
    createDocumentNT2(formDocumentNT2);
});

function createDocumentNT2(input) {
    let urlService = "/service/doc/createDocumentNT2";
